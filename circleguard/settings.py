...
COMMENTS = {
    "file": "Please read the following before editing this file.\n"
            ...
            "These denote section to be filled with python's strformat. We do not currently document what variables are passed to you through strformat for each setting.\n"
